...
def scattering_node_group():
    scattering = bpy.data.node_groups.new(type='GeometryNodeTree', name="scattering")
    ...
    # Set locations
    random_value_001.location = (166.96701049804688, -159.7490234375)
    collection_info.location = (-11.898445129394531, 59.760009765625)
    random_value.location = (-15.9769926071167, -103.20598602294922)
    realize_instances.location = (519.3212280273438, 48.670494079589844)
    group_output.location = (697.9645385742188, 49.992462158203125)
    instance_on_points.location = (334.42626953125, 29.316762924194336)
